<meta charset="utf-8" />
<title>Intellitool - A Facility Management Service</title>
...
<link href="{{ asset(config('constants.adminAssets').'global/css/components.min.css') }}" rel="stylesheet" id="style_components" type="text/css" />
<link href="{{ asset(config('constants.adminAssets').'global/css/plugins.min.css') }}" rel="stylesheet" type="text/css" />
