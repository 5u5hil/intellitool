            ...
            <form action="#" class="repeater form-horizontal">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-diamond"></i>Client Info </div>
                        <div class="tools">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-directions"></i>Coordinator Details </div>
                        <div class="tools">
                            <a href="javascript:;" class="collapse"> </a>
                        </div>
                    </div>
                                                ...
                                                <div class="input-group control-group after-add-more col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Coordinator Phone">
                                                        </div>
                                                        <div class="col-md-1">
                                                        <label></label>
                                                            <button href="#" class="btn btn-danger pull-right remove" style="margin-top: 20px;">
